...
def describe_single_mass_model():
    ...
    def describe_math():
        ...
        def single_mass_model():
            ...
            model = SingleMassBaryonModel(redshift=redshift)
            return model
        ...
        def it_can_use_different_units():
            redshift = 0.4*np.ones(1)
            model = SingleMassBaryonModel(redshift=redshift, units=u.Msun/u.Mpc**2)
        ...
        def it_can_use_different_mass_definitions():
            ...
            delta = 500
            mass_def = 'crit'
            model = SingleMassBaryonModel(redshift=redshift, delta=delta, mass_definition=mass_def)
