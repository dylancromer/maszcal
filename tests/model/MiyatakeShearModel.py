...
stacked_model = MiyatakeShearModel(mus, zs, units=u.Msun/(u.pc**2), delta=500, mass_definition='crit')
...
def test_delta_sigma_of_m():
    ...
    plt.savefig('figs/test/delta_sigma_r_m_with_cm_relation.svg')
    plt.gcf().clear()
...
def test_delta_sigma_of_r():
    ...
    plt.savefig('figs/test/delta_sigma_r_with_cm_relation.svg')
    plt.gcf().clear()
...
def test_delta_sigma_of_m_nocomoving():
    ...
    plt.savefig('figs/test/delta_sigma_r_m_comoving_false_with_cm_relation.svg')
    plt.gcf().clear()
...
def test_delta_sigma_of_r_nocomoving():
    ...
    plt.savefig('figs/test/delta_sigma_r_comoving_false_with_cm_relation.svg')
    plt.gcf().clear()
