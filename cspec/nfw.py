...
def describe_MatchingNfwModel():
    ...
    def nfw_model():
        cosmo = CosmoParams()
        return cmaszcal.nfw.MatchingNfwModel(cosmo_params=cosmo)
...
def describe_MatchingCmNfwModel():
    ...
    def nfw_model():
        cosmo = CosmoParams()
        return cmaszcal.nfw.MatchingCmNfwModel(cosmo_params=cosmo)
...
def describe_NfwCmModel():
    ...
    def nfw_model():
        cosmo = CosmoParams()
        return cmaszcal.nfw.NfwCmModel(cosmo_params=cosmo)
    ...
    def it_can_use_different_units(nfw_model):
        nfw_model_other_units = cmaszcal.nfw.NfwCmModel(units=u.Msun/u.Mpc**2)
    ...
    def it_can_use_different_mass_definitions(nfw_model):
        nfw_model_500c = cmaszcal.nfw.NfwCmModel(delta=500, mass_definition='crit')
    ...
    def it_must_use_a_correct_mass_definition():
        with pytest.raises(ValueError):
            cmaszcal.nfw.NfwCmModel(mass_definition='oweijf')

    def it_can_use_comoving_coordinates(nfw_model):
        nfw_model_nocomoving = cmaszcal.nfw.NfwCmModel(units=u.Msun/u.pc**2, comoving=False)
...
def describe_NfwModel():
    ...
    def nfw_model():
        cosmo = CosmoParams()
        return cmaszcal.nfw.NfwModel(cosmo_params=cosmo)
    ...
    def it_can_use_different_units(nfw_model):
        nfw_model_other_units = cmaszcal.nfw.NfwModel(units=u.Msun/u.Mpc**2)
    ...
    def it_can_use_different_mass_definitions(nfw_model):
        nfw_model_500c = cmaszcal.nfw.NfwModel(delta=500, mass_definition='crit')
    ...
    def it_must_use_a_correct_mass_definition():
        with pytest.raises(ValueError):
            cmaszcal.nfw.NfwModel(mass_definition='oweijf')

    def it_can_use_comoving_coordinates(nfw_model):
        nfw_model_nocomoving = cmaszcal.nfw.NfwModel(units=u.Msun/u.pc**2, comoving=False)
...
def describe_SingleMassNfwModel():
    ...
    def nfw_model():
        cosmo = CosmoParams()
        return cmaszcal.nfw.SingleMassNfwModel(cosmo_params=cosmo)
