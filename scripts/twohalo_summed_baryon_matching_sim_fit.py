...
if __name__ == '__main__':
    ...
    one_halo_shear_model = get_shear_model(density_model.excess_surface_density)
    ...
    def wrapped_1h_esd_func(params):
        ...
        return one_halo_shear_model.stacked_excess_surface_density(SIM_DATA.radii, a_sz, con, alpha, beta, gamma).squeeze()
