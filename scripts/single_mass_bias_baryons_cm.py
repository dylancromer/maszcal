...
def calculate_baryon_cm_fits(i, sim_data, _pool_func):
...
if __name__ == '__main__':
    ...
    for i, z in enumerate(sim_data.redshifts):
        ...
        def _pool_func(data): return _get_best_fit(data, sim_data.radii, esd_model_func, act_fisher, BARYON_CM_PARAM_MINS, BARYON_CM_PARAM_MAXES)

        baryon_cm_fits[:, :, i] = calculate_baryon_cm_fits(i, sim_data, _pool_func)
