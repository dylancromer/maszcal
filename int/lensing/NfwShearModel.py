...
from maszcal.lensing import NfwShearModel
...
def describe_nfw_shear_model():
    ...
    def test_excess_surface_density_of_m(stacked_model):
        ...
        excess_surface_densities = stacked_model.excess_surface_density(rs, mus, cons)

        excess_surface_densities = excess_surface_densities[0,:,:,0]
        ...
        plt.savefig('figs/test/excess_surface_density_r_m.svg')
        plt.gcf().clear()
    ...
    def test_excess_surface_density_of_r(stacked_model):
        ...
        excess_surface_densities = stacked_model.stacked_excess_surface_density(rs, cons, a_szs)[:,0]

        plt.plot(rs, rs * excess_surface_densities)
        plt.xlabel(r'$ r $')
        plt.ylabel(r'$ r \Delta \Sigma (10^6 \, M_{\odot} / \mathrm{{pc}}) $')
        plt.xscale('log')

        plt.savefig('figs/test/excess_surface_density_r.svg')
        plt.gcf().clear()
    ...
    def test_excess_surface_density_of_m_nocomoving(stacked_model):
        ...
        plt.savefig('figs/test/excess_surface_density_r_m_comoving_false.svg')
        plt.gcf().clear()
    ...
    def test_excess_surface_density_of_r_nocomoving(stacked_model):
        ...
        plt.savefig('figs/test/excess_surface_density_r_comoving_false.svg')
        plt.gcf().clear()
